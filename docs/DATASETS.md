...
The minimal demo uses only a small subset of the Urban Observatory data. To avoid duplicating datasets, demo files are generated from the full `.csv.xz` files:
...
For the minimal demo specifically:
