...
echo "[6/11] 🏭 Cooler Motor (Now with TLS support)..."
docker build -t myzoo/cooler_motor ./devices/cooler_motor

echo "[7/11] ⚙️  Predictive Maintenance..."
