...
def telemetry(sleep_t, sleep_t_sd, event, die_event, mqtt_topic, broker_addr, mqtt_auth, mqtt_qos, mqtt_tls, mqtt_cacert, mqtt_tls_insecure):
    ...
    dataset_columns = ["farm_id",
                       ...
                       "NDVI_index",
                       "crop_disease_status",]
    dataset_units = ["Unique ID",
                     None,
                     None,
                     "%",
                     "Soil pH level",
                     "°C",
                     "Total rainfall in mn",
                     "%",
                     "Average sunlight hours received per day",
                     "Type of irrigation: Drip, Sprinkler, Manual, None",
                     "Fertilizer used: Organic, Inorganic, Mixed",
                     "milliliters",
                     "YYYY/MM/DD",
                     "YYYY/MM/DD",
                     "Crop growth duration (harvest - sowing)",
                     "kilograms per hectare",
                     "ID",
                     "YYYY/MM/DD",
                     "latitude",
                     "longitude",
                     "Normalized Difference Vegetation Index (0.3 - 0.9)",
                     "Crop disease status: None, Mild, Moderate, Severe"]
